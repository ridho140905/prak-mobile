...
import com.example.ridhoapps.databinding.FragmentTabQrcodeBinding
...
class TabQrcodeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // PERBAIKAN 1: Inisialisasi binding agar tidak crash
        _binding = FragmentTabQrcodeBinding.inflate(inflater, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState) // Praktik terbaik: panggil super
    ...
    override fun onDestroyView() {
        super.onDestroyView() // PERBAIKAN 2: Wajib memanggil super agar tidak error merah
        _binding = null
    }
}